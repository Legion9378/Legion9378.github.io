...
idleGame.service('gameService', function() {
	...
	this.items = [
		{ id: 0, name: "Minimum Wage Worker", mps: .2 , price: 15 },
		{ id: 1, name: "Cubicle", mps: .5 , price: 100 },
		{ id: 2, name: "Salary Employee", mps: 6, price: 1500 },
		{ id: 7, name: "Hardware", mps: 3, price: 1500 },
		{ id: 9, name: "HR Department", mps: 2, price: 2000 },
		{ id: 4, name: "Accounting Department", mps: 6, price: 5000 },
		{ id: 5, name: "Benefits Package", mps: 6, price: 25000 },
		{ id: 3, name: "Upper Management", mps: 4, price: 50000 },
		{ id: 6, name: "Executive", mps: 100, price: 100000 },
		{ id: 8, name: "Office Building", mps: 2000, price: 500000 }
	];
	...
	this.upgrades = [
		{ id: 0, itemId: 0, name: "Positive Reinforcement", price: 500, mps: .1,
		...
		{ id: 1, itemId: 0, name: "Mentoring Program", price: 1500, mps: .5, count: 10,
		...
		{ id: 2, itemId: 0, name: "Better Scheduling", price: 30000, mps: .5, count: 100,
		...
		{ id: 3, itemId: 1, name: "Lower Walls", price: 1000, mps: .5,
		...
		{ id: 6, itemId: 2, name: "Four Tens", price: 10000, mps: 3, 
		...
		{ id: 7, itemId: 2, name: "Free Lunch", price: 60000, mps: 6, count: 10,
			description: "I guess there is such a thing." },
		{ id: 8, itemId: 2, name: "80/20", price: 1200000, mps: 12, count: 100,
		...
		{ id: 12, itemId: 9, name: "Employee Handbook", price: 50000, mps: 5, 
			description: "Make sure you read every page!" },
		{ id: 13, itemId: 9, name: "Policy Documentation", price: 100000, mps: 5, count: 10,
			description: "Your employees will make an extra effort to comply with the company's policies." },
		{ id: 14, itemId: 9, name: "Christmas Party", price: 150000, mps: 5, count: 100,
		...
		{ id: 15, itemId: 3, name: "Useless Meetings", price: 1000000, mps: 50, 
			description: "None of your employees are suffering from insomnia after that meeting!" },
		{ id: 16, itemId: 3, name: "Even More #$^&*% Useless Meetings", price: 1750000, mps: 50, count: 10,
			description: "None of your employees are suffering from insomnia after *that* meeting!" },
		{ id: 17, itemId: 3, name: "Micromanagement", price: 2500000, mps: 50, count: 100,
			description: "Upper Management does their best to get the most out of them slacking employees!" },
		
		{ id: 24, itemId: 6, name: "Executive Bathroom", price: 10000000, mps: 55, 
			description: "The most prized possession of every executive." },
		{ id: 25, itemId: 6, name: "Goal Oriented Bonuses", price: 20000000, mps: 150, count: 10,
		...
		{ id: 26, itemId: 6, name: "Golden Handcuffs", price: 30000000, mps: 15, count: 500,
		...
		{ id: 27, itemId: 8, name: "Recreations", price: 50000000, mps: 250, 
		...
		{ id: 28, itemId: 8, name: "Electric Car Charging Parking Lot", price: 100000000, mps: 500, count: 10,
			description: "Now your employees can take their Tesla to work." },
		{ id: 29, itemId: 8, name: "Improved Space", price: 150000000, mps: 1000, count: 100,
		...
		{ id: 71, itemId: "Business Opportunity", name: "Starting Business", price: 5, mps: 1, mpo: 10, isOpportunity: 1, isBusiness: 1,
			description: "Starting a new business makes you feel young and alive again!" },
		{ id: 75, itemId: "Business Opportunity", name: "Business Innovator", price: 400, mps: 10, mpo: 25, isOpportunity: 1, showAfter: [71], isBusiness: 1,
			description: "You're starting to make waves in the industry." },
		{ id: 30, itemId: "Business Opportunity", name: "Business Guru", price: 1000, mps: 20, mpo: 80, isOpportunity: 1, showAfter: [75], isBusiness: 1,
		...
		{ id: 31, itemId: "Business Opportunity", name: "Business Expert", price: 10000, mps: 30, mpo: 200, isOpportunity: 1, showAfter: [30], isBusiness: 1,
			description: "Your expertise in everything business just put you on Glassdoor.com's Top CEO list." },
		{ id: 32, itemId: "Business Opportunity", name: "Business Savant", price: 100000, mps: 40, mpo: 2000, isOpportunity: 1, showAfter: [31], isBusiness: 1,
			description: "Your eat your competition for breakfast." },
		{ id: 44, itemId: "Business Opportunity", name: "Business Epic", price: 1000000, mps: 50, mpo: 20000, isOpportunity: 1, showAfter: [32], isBusiness: 1,
			description: "Absorb the competition." },
		{ id: 76, itemId: "Business Opportunity", name: "Business Leader", price: 25000000, mps: 60, mpo: 500000, isOpportunity: 1, showAfter: [44], isBusiness: 1,
		...
		{ id: 36, itemId: "Money/Second", name: "Night Owl", price: 250000, mps: 0, isOnLoad: 1, per: .83, isBusiness: 1,
			description: "Gain a small part of your money even while the game is closed." },
		{ id: 37, itemId: "Money/Second", name: "Night Owl II", price: 2500000, mps: 0, isOnLoad: 1, per: .83, showAfter: [36], isBusiness: 1,
			description: "Gain a small part of your money even while the game is closed." },
		{ id: 38, itemId: "Money/Second", name: "Night Owl III", price: 25000000, mps: 0, isOnLoad: 1, per: .03, showAfter: [37], isBusiness: 1,
			description: "Gain a small part of your money even while the game is closed." },

		{ id: 39, itemId: "Money/Second", name: "Over Achiever", price: 100000000, isAchievement: 1, per: .25, isBusiness: 1,
			description: "Gain a percentage increase of Money/Second for every achievement earned." },
		{ id: 40, itemId: "Money/Second", name: "Butt Kisser", price: 1000000000, isAchievement: 1, per: .5, showAfter: [39], isBusiness: 1,
			description: "Gain a percentage increase of Money/Second for every achievement earned." },
		{ id: 41, itemId: "Money/Second", name: "Brown Noser", price: 10000000000, isAchievement: 1, per: 1, showAfter: [40], isBusiness: 1,
			description: "Gain a percentage increase of Money/Second for every achievement earned." },
	];
