var weedBuildsOwned;
var weedBuilds = [
    new Build("Closet Grow Room",	250,            	0.6,    1.60, 0),
    new Build("Backyard",	500000,          	3,    	1.50, 0),
    new Build("Green House",	25000000,        	7,   	1.40, 0),
    new Build("Brazilian Farm",	750000000,			8,    	1.30, 0),
];

var methBuildsOwned;
var methBuilds = [
    new Build("Mobile RV Lab",    1000000,         	4,    	1.60, 1),
    new Build("Basement Lab",    750000000,       	8,    	1.50, 1),
    new Build("Chemical Warehouse",    50000000000,      	16,		1.40, 1),
    new Build("Professional Chemical Lab",	1000000000000,		24,    	1.30, 1),
];

var cocaineBuildsOwned;
var cocaineBuilds = [
    new Build("Small Farm",	25000000000,		8,    	1.60, 2),
    new Build("Cocaine Field",	750000000000,    	16,    	1.50, 2),
    new Build("Bolivian Farm",	2500000000000,   	24,		1.40, 2),
    new Build("Columbian Estate",	1000000000000000, 	40,		1.30, 2),
];
