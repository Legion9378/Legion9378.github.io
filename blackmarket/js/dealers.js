...
var weedDealers = [
    new Dealer("Backyard Dealer",		250,                0.80,   1.30,	0),
    new Dealer("Small Time Dealer",		500000,             2,		1.25,	0),
    new Dealer("Downtown Dealer",		25000000,           4,      1.20,	0),
    new Dealer("Nightclub Owner",		750000000,          7,      1.15,	0),
];

var methDealersOwned;
var methDealers = [
    new Dealer("Dark Alley",		1000000,            3,   	1.30, 	1),
    new Dealer("Meth House",		750000000,          6,		1.25, 	1),
    new Dealer("Local Gangsters",  	50000000000,        12,      1.20, 	1),
    new Dealer("Mafia Associates",		1000000000000,		20,     1.15, 	1),
];

var cocaineDealersOwned;
var cocaineDealers = [
    new Dealer("Local Club Chauffeur",      25000000000,        6,		1.30,	2),
    new Dealer("Casino Owner",      750000000000,       12,		1.25,	2),
    new Dealer("Executive's Club Chairman",      2500000000000,      20,		1.20,	2),
    new Dealer("Drug Trafficking Syndicate",      1000000000000000,   36,		1.15,	2)
];
